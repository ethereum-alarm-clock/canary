...
var
SendAsync = function () {
  function SendAsync(provider) {_classCallCheck(this, SendAsync);
    this._provider = provider;
  }_createClass(SendAsync, [{ key: 'send', value: function send()

    {
      throw new Error('Provider does not support the sync send(payload) method');
    } }, { key: 'sendAsync', value: function sendAsync(_ref,

    callback) {var method = _ref.method,params = _ref.params;
      this._provider.send(method, params, function (error, result) {
